...
urlpatterns = [
    ...
    url(r'^(?P<employee_id>\d+)/delete-employee/$', views.delete_employee, name='delete-employee'),
    url(r'^(?P<company_name>[\w\-\ ]+)/update-company/$', views.update_company, name='update-company'),
    url(r'^(?P<company_name>[\w\-\ ]+)/(?P<employee_id>\d+)/update-employee/$', views.update_employee, name='update-employee'),
